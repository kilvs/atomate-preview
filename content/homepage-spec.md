...
- Hero flow graphic, paper sheets with one subtle fade-up since 18 Sep (client reference strings): label **ATO correspondence**; cards **Notices of assessment · PAYG instalment notices · BAS statements · Div 293 notices · Other ATO correspondence** → ATOmate → ticks **Client-ready communication · TFNs redacted · Ready for review & approval · Filed in your DMS · Nothing gets missed**. The "Client-ready output" heading is left off, per the client.
